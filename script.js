// var username = "Omoustaf";

// if (username === "Omoustaf") {
//     console.log(true);
//   }
...
// 	},
// };
// console.log(Omar.weapon);
// console.log(Omar ["weapon"]);
// console.log(Omar.greet());
// Omar.age = 139;
// Omar["age"] = 139;
// console.log(Omar.age);

// Omar.fight = function() {
// 	return `Omar attacks with an ${this.weapon}.`;
// }
// console.log(Omar.fight());
// Omar.weapon = "Glock 17";
// console.log(Omar);
// console.log(delete Omar.weapon);
// console.log(Omar);
...
// };
// for (let key in Omar) {
//     console.log(Omar[key]);
//   }
//   for (let key in Omar) {
//     console.log(key.toUpperCase() + ':', Omar[key]);
//   }
